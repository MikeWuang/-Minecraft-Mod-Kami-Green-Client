...
public class KamiMod {
    ...
    public static final String MODNAME = "KAMI Green";
    public static final String MODID = "kamigreen";
    public static final String VER_FULL_BETA = "v1.0.0-beta"; // this is changed to v1.x.x-commit for debugging by automatic builds
    public static final String VER_SMALL = "v1.0.0-beta"; // shown to the user, unchanged
    public static final String VER_STABLE = "v1.0.0"; // used for update checking

    public static final String APP_ID = "744107212879822889";

    public static final String DOWNLOADS_API = "https://kami-green.herokuapp.com/api/v1/downloads";
    ...
    public static final String WEBSITE_LINK = "https://kamigreen.org";
    ...
    public void updateCheck() {
        try {
            KamiMod.log.info("Attempting KAMI Green update check...");
            ...
            if (!isLatest) {
                KamiMod.log.warn("You are running an outdated version of KAMI Green.\nCurrent: " + VER_STABLE + "\nLatest: " + latestVersion);

                return;
            }

            KamiMod.log.info("Your KAMI Green (" + VER_STABLE + ") is up-to-date with the latest stable release.");
        } catch (IOException e) {
            latest = null;
